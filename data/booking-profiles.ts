...
const sharedContactFields: BookingField[] = [
  ...
  { name: "phone", label: "Phone or WhatsApp", placeholder: "+251 ...", type: "tel", required: true },
...
export const bookingProfiles: Record<string, BookingProfile> = {
  ...
  "cargo-logistics": {
    ...
    fields: [
      ...sharedContactFields,
      { name: "cargoType", label: "Cargo type", placeholder: "Select cargo type", options: ["General Cargo", "Dangerous Goods", "Temperature Controlled", "Valuable Cargo", "Live Animals", "Fragile", "Other"], required: true },
  ...
  "fuel-coordination": {
    ...
    fields: [
      ...sharedContactFields, 
      { name: "aircraftRegistration", label: "Aircraft registration", placeholder: "e.g. ET-XXX", required: true }, 
      { name: "aircraftType", label: "Aircraft type", placeholder: "e.g. B737-800", required: true }, 
      { name: "flightNumber", label: "Flight number", placeholder: "e.g. AB123" }, 
      { name: "fuelType", label: "Fuel type", placeholder: "Select fuel type", options: ["Jet A-1", "Avgas", "Other"], required: true }, 
      { name: "quantity", label: "Requested quantity", placeholder: "e.g. 12,000", type: "number", required: true }, 
      { name: "unit", label: "Unit", placeholder: "Select unit", options: ["Litres", "US Gallons", "Lbs", "Kgs"], required: true }, 
      { name: "upliftDate", label: "Uplift date", placeholder: "Select date", type: "date", required: true }, 
      { name: "upliftTime", label: "Uplift time", placeholder: "Select time", type: "time", required: true }, 
